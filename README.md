...
## A venir
Les features suivantes sont envisagées pour le futur :
- Visualisation du profil de la randonnée (altitude)
- Affichage de la distance du parcours
- Affichage des dénivelés positifs et négatifs de la randonnée